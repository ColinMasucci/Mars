...
One line install scripts have been provided for common operating systems, however its worth noting that the ROS compatibility will not function on OS's that do not support/have ROS installed.
